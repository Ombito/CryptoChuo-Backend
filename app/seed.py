...
with app.app_context():
    ...
    courses_data = [
        {'title': 'Blockchain Fundamentals', 'user_id': 1, 'description': 'Learn the basic concepts and principles of blockchain technology.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121950/bitcoin_zdcmwz.png', 'category': 'Technology', 'price': 19.99, 'rating': 4.5, 'duration': '1 week', 'level': 'Beginner', 'grouping':'trending', 'grouping':'suggested'},
        {'title': 'Smart Contracts Development', 'user_id': 2, 'description': 'Hands-on experience in developing smart contracts on various blockchain platforms.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121952/mobile_p8imcc.png', 'category': 'Programming', 'price': 29.99, 'rating': 4.8, 'duration': '12 hours', 'level': 'Intermediate', 'grouping':'trending'},
        {'title': 'Decentralized Finance (DeFi)', 'user_id': 5, 'description': 'Explore decentralized financial systems and applications.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121952/bitcoindecentralization_rtol77.png', 'category': 'Finance', 'price': 49.99, 'rating': 4.7, 'duration': '35 hours', 'level': 'Advanced', 'grouping':'trending'},
        {'title': 'Cryptocurrency Trading Strategies', 'user_id': 3, 'description': 'Explore effective trading strategies for cryptocurrencies and market analysis..', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121951/bitcoinlogo_oyj6i0.png', 'category': 'Finance', 'price': 69.99, 'rating': 4.5, 'duration': '48 hours', 'level': 'Intermediate', 'grouping':'trending'},
        {'title': 'Decentralized Applications (DApps) Development', 'user_id': 5, 'description': 'Hands-on experience in developing decentralized applications on blockchain platforms.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121954/p2p_itocki.png', 'category': 'Programming', 'price': 99.99, 'rating': 4.9, 'duration': '4 months', 'level': 'Advanced', 'grouping':'suggested'},
        ...
        {'title': 'Blockchain and Healthcare', 'user_id': 3, 'description': 'Applications of blockchain technology in the healthcare industry.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121952/decentralisation_qiwfzr.png', 'category': 'Health', 'price': 79.99, 'rating': 4.6, 'duration': '30 hours', 'level': 'Intermediate', 'grouping':'suggested'},
        {'title': 'Ethereum Smart Contracts Security', 'user_id': 4, 'description': 'Security considerations in the development of smart contracts on the Ethereum platform.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121950/13808c27-ab9f-4c04-95db-83d0fc577544_bbcm4f.png', 'category': 'Programming', 'price': 89.99, 'rating': 4.8, 'duration': '72 hours', 'level': 'Advanced', 'grouping':'trending'},
        ...
        {'title': 'Cryptocurrency Investment Strategies', 'user_id': 2, 'description': 'Learn effective strategies for investing in cryptocurrencies.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121972/trading_pspwqn.gif', 'category': 'Finance', 'price': 29.99, 'rating': 4.9, 'duration': '6 hours', 'level': 'Intermediate', 'grouping':'suggested'},
        {'title': 'Hyperledger Fabric Development', 'user_id': 3, 'description': 'Hands-on experience in developing applications using Hyperledger Fabric.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121988/science_hwe25p.gif', 'category': 'Programming', 'price': 99.99, 'rating': 4.8, 'duration': '4 weeks', 'level': 'Advanced', 'grouping':'trending'},
        {'title': 'Ripple and XRP Explained', 'user_id': 4, 'description': 'An in-depth look at Ripple and its native cryptocurrency XRP.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704121957/transaction_d7n3d0.png', 'category': 'Technology', 'price': 29.99, 'rating': 4.5, 'duration': '8 hours', 'level': 'Beginner', 'grouping':'featured'},
        {'title': 'NFTs and Digital Art', 'user_id': 2, 'description': 'Understanding Non-Fungible Tokens (NFTs) and their impact on the art world.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704136275/a0faacd3-6428-46c8-8f33-a64f27e67f1a_u9bejm.png', 'category': 'Art', 'price': 29.99, 'rating': 4.4, 'duration': '6 hours', 'level': 'Beginner', 'grouping':'trending'},
        {'title': 'Introduction to Solidity Programming', 'user_id': 1, 'description': 'Learn the basics of programming smart contracts using Solidity.', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704136794/f2d8563c-c7ba-434a-b403-8d25e971ef60_xpdsdt.png', 'category': 'Programming', 'price': 49.99, 'rating': 4.4, 'duration': '30 hours', 'level': 'Beginner', 'grouping':'trending'},
        ...
        {'title': 'Blockchain and Legal Implications', 'user_id': 4, 'description': 'Understand the legal implications and challenges of blockchain technology', 'image': 'https://res.cloudinary.com/duofzxtxh/image/upload/v1704136794/e99f3547-4ee4-45d9-9b93-1b27b492edae_p7gdb2.png', 'category': 'Business', 'price': 49.99, 'rating': 4.6, 'duration': '8 hours', 'level': 'Intermediate', 'grouping':'trending'},
    ...
    merchandise_data = [
        ...
        {'name': 'Bitcoin Hoodie', 'description': 'Warm hoodie with a Bitcoin logo for crypto enthusiasts.', 'image': 'new image', 'price': 29.99, 'rating': 4.5, 'category': 'top_deals', 'grouping':'suggested'},
        ...
        {'name': 'Ripple Water Bottle', 'description': 'Stainless steel water bottle featuring the Ripple logo.', 'image': 'new image', 'price': 19.99, 'rating': 4.0, 'category': 'flash_sales', 'grouping':'suggested'},
        ...
        {'name': 'NFT Art Canvas', 'description': 'Canvas print featuring exclusive NFT artwork from a renowned crypto artist.', 'image': 'new image', 'price': 49.99, 'rating': 4.8, 'category': 'top_deals', 'grouping':'suggested'},
        ...
        {'name': 'Blockchain Watch', 'description': 'Elegant wristwatch with blockchain-inspired design and features.', 'image': 'new image', 'price': 69.99, 'rating': 4.5, 'category': 'top_deals', 'grouping':'suggested'},
