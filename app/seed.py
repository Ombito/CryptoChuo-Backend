...
with app.app_context():
    ...
    courses_data = [
        ...
        {'title': 'Ripple and XRP Explained', 'user_id': 4, 'description': 'An in-depth look at Ripple and its native cryptocurrency XRP.', 'image': 'new image', 'category': 'Technology', 'price': 29.99, 'rating': 4.5, 'duration': '8 hours', 'level': 'Beginner'},
        {'title': 'NFTs and Digital Art', 'user_id': 2, 'description': 'Understanding Non-Fungible Tokens (NFTs) and their impact on the art world.', 'image': 'new image', 'category': 'Art', 'price': 29.99, 'rating': 4.4, 'duration': '6 hours', 'level': 'Beginner'},
        {'title': 'Introduction to Solidity Programming', 'user_id': 1, 'description': 'Learn the basics of programming smart contracts using Solidity.', 'image': 'new image', 'category': 'Programming', 'price': 49.99, 'rating': 4.4, 'duration': '30 hours', 'level': 'Beginner'},
        ...
        {'title': 'Blockchain and Legal Implications', 'user_id': 4, 'description': 'Understand the legal implications and challenges of blockchain technology', 'image': 'new image', 'category': 'Business', 'price': 49.99, 'rating': 4.6, 'duration': '8 hours', 'level': 'Intermediate'},
