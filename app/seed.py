...
with app.app_context():
    ...
    merchandise_data = [
        ...
        {'name': 'EOS Sunglasses', 'description': 'Stylish sunglasses with the EOS logo for protection under the sun.', 'image': 'new image', 'price': 25.99, 'rating': 4.8, 'category': 'accessories'},
    ]
